...
import com.tdeado.core.provider.QueryHandlerMethodArgumentResolver;
...
public class ConfigArgumentResolvers {
    ...
    private void addArgumentResolvers() {
        ...
        QueryHandlerMethodArgumentResolver myHandlerMethodArgumentResolver =
     ...
     */
    private QueryHandlerMethodArgumentResolver getMyHandlerMethodArgumentResolver(
        ...
        return new QueryHandlerMethodArgumentResolver(requestResponseBodyMethodProcessor,
